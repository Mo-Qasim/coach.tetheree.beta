    ...
    return (
        <header className="bg-theme relative">
            ...
            <div className="container max-w-[800px] mx-auto mb-32">
                <section className='w-full flex flex-col items-center justify-center text-white pt-136 px-20'>
                    <H5 className='font-medium'>increase athletic performance</H5>
                    <H1 className='text-center text-white mb-16'>Extend your influence</H1>
                    <H4 className='w-full md:w-3/4 text-center !text-white mb-42'>Allow your athletes to revisit their performance and reflect upon your caching advice on their own time</H4>
                    ...
                    <Caption className='!text-white font-normal mb-16'>free 7 days trial no credit card required</Caption>
